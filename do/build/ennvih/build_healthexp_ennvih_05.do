...
use "ehh05dta_all/ehh05dta_b3b/iiib_ec.dta",clear // cronic disease
...
cd "$projdir/dta/src/ENNVIH"
use "ehh05dta_all/ehh05dta_b3b/iiib_ats.dta", clear // self-prescription
...
cd "$projdir/dta/src/ENNVIH"
use "ehh05dta_all/ehh05dta_b3b/iiib_ce1.dta", clear // external doctor visit
...
cd "$projdir/dta/src/ENNVIH"
use "ehh05dta_all/ehh05dta_b3b/iiib_hs1.dta", clear // hospitalization
