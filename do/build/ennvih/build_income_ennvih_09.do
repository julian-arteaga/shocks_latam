...
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b2/ii_su1.dta", clear
...
* Rural income (INR):
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b2/ii_inr.dta", clear
...
* Non-ag business (NNA):
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b2/ii_nna1.dta", clear
...
replace nonagbiz_earn = . if nonagbiz_earn < -100000 // 0 obs
...
egen nonlab_inc_yr = rowtotal(											   ///
	 /*in01a1_2*/ in01a2_2 in01a3_2 /*in01a4_2*/ in01a5_2 in01a6_2     	   ///
	 in01a7_2 /*in01a8_2*/ in01a9_2 in01a10_2 in01a11_2 in01a12_21 		   ///
	 in01a13_21 in01b_2 in01c_2 in01d_2     							   ///
	 in01e_2 in01f_2 in01g_2 in01h_2 in01i_2 in01j_2 in01k_21   		   ///				
...
// Some clear outliers:
replace tb35a_2 = . if tb35a_2 > 1000000 // 0 obs
replace tb35aa_2 = . if tb35aa_2 >= 400000 // 1 obs
replace tb35ac_2 = . if tb35ac_2 >= 400000 // 0 obs
...
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b3b/iiib_tp.dta", clear

egen trsf_p = rowtotal(tp26a  tp26b tp26c tp26f_21 						   ///
					   tp26ma tp26mb tp26mc tp26mf_21 					   ///
					   tp26pa tp26pb tp26pc tp26pf_21)
...
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b3b/iiib_th2.dta", clear
...
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b3b/iiib_thi2.dta", clear
...
use "$projdir/dta/src/ENNVIH/ehh09dta_all/ehh09dta_b3b/iiib_to.dta", clear
...
save "ennvih_income_hhlvl_09.dta", replace
