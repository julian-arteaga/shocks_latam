...
* Compute ENNVIH health expenditure level 2002

* -----------------

cd "$projdir/dta/src/ENNVIH"
use "ehh02dta_all/ehh02dta_b3b/iiib_ec.dta",clear // cronic disease

egen exp_crc_mth = rowtotal(ec03a ec03b ec03c ec03d 				       ///
							   ec03e ec03f ec03g ec03h ec03i)
...
cd "$projdir/dta/src/ENNVIH"
use "ehh02dta_all/ehh02dta_b3b/iiib_ats.dta", clear // self-prescription

egen exp_ats_mth = rowtotal(ats02a_2 ats02b_2 ats02c_2)
...
cd "$projdir/dta/src/ENNVIH"
use "ehh02dta_all/ehh02dta_b3b/iiib_ce1.dta", clear // external doctor visit
...
* Transport cost in this year is extremely high. Comparing with other waves 
* it looks like it is a typo (got x100)

replace ce17_2 = ce17_2 / 100
...
cd "$projdir/dta/src/ENNVIH"
use "ehh02dta_all/ehh02dta_b3b/iiib_hs1.dta", clear // hospitalization
