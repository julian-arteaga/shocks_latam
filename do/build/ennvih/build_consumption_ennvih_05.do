...
* Consumption 0:  
use "$projdir/dta/src/ENNVIH/ehh05dta_all/ehh05dta_b1/i_cs.dta", clear
...
* Consumption 1: 
use "$projdir/dta/src/ENNVIH/ehh05dta_all/ehh05dta_b1/i_cs1.dta", clear
...
merge 1:1 folio_05 using `consumption_0'
drop _merge 

* Merge-in health expenditures:
cd "$projdir/dta/cln/ENNVIH"
merge 1:1 folio_05 using "ennvih_healthexp_hhlvl_05.dta"
drop if _merge == 2 // not in roster
...
replace consumo_transfers = consumo_transfers + diff if abs(diff) > 20 // 32obs
...
keep folio_05 year consumo_* hh_totexp
...
cd "$projdir/dta/cln/ENNVIH"
save "ennvih_consump_hhlvl_05.dta", replace
