...
use "panel/2017_2021/sumaria-2017-2021-panel.dta", clear
...
tempfile sumpanel_20172021
save `sumpanel_20172021'

* -----------------

* Household characteristics: 

forvalues y = 2017(1)2021 {
...
merge 1:1 conglome vivienda hogar year using `sumpanel_20172021'
drop _merge 

rename hpanel_* hpan*
drop hpan*s

gen ispanel = inlist(1, hpan1718, hpan1819, hpan1920, hpan2021)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1721.dta", replace
