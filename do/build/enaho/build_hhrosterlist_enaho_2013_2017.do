...
use "panel/2013_2017/sumaria_2013_2017_panel.dta", clear
...
tempfile sumpanel_20132017
save `sumpanel_20132017'

* -----------------

* Household characteristics: 

forvalues y = 2013(1)2017 {
...
merge 1:1 conglome vivienda hogar year using `sumpanel_20132017'
drop _merge 

gen ispanel = inlist(1, hpan1314, hpan1415, hpan1516, hpan1617)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1317.dta", replace
