...
use "panel/2019_2023/sumaria-2019-2023-panel.dta", clear
...
tempfile sumpanel_20192023
save `sumpanel_20192023'

* -----------------

* Household characteristics: 

forvalues y = 2019(1)2023 {
...
merge 1:1 conglome vivienda hogar year using `sumpanel_20192023'
drop _merge 
...
rename hpan22_* hpan22*

drop hpan*s

gen ispanel = inlist(1, hpan1920, hpan2021, hpan2122, hpan2223)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1923.dta", replace
