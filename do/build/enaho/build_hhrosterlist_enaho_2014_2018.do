...
use "panel/2014_2018/sumaria-2014-2018-panel.dta", clear
...
tempfile sumpanel_20142018
save `sumpanel_20142018'
...
merge 1:1 conglome vivienda hogar year using `sumpanel_20142018'
drop _merge 

gen ispanel = inlist(1, hpan1415, hpan1516, hpan1617, hpan1718)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1418.dta", replace
