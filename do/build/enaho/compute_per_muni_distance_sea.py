...
# Compute distance-to-sea from distrito centroid - PERU
...
municipalities = (
	gpd.read_file(path + "/dta/src/SHP/per/distritos_peru.shp")
)

municipalities = municipalities.to_crs("EPSG:32718")
...
centroids[["UBIGEO", "distance_to_sea_km"]].to_csv(
	path + "/dta/cln/ENAHO/per_munic_sea_distances.csv", index=False
)
