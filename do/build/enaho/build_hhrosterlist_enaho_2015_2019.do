...
use "panel/2015_2019/sumaria-2015-2019-panel.dta", clear
...
tempfile sumpanel_20152019
save `sumpanel_20152019'

* -----------------

* Household characteristics: 

forvalues y = 2015(1)2019 {
...
merge 1:1 conglome vivienda hogar year using `sumpanel_20152019'
drop _merge 

rename hpanel_* hpan*

gen ispanel = inlist(1, hpan1516, hpan1617, hpan1718, hpan1819)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1519.dta", replace
