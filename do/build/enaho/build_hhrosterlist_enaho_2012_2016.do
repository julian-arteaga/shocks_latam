...
use "panel/2012_2016/sumaria_2012_2016_panel.dta", clear
	
isid cenl 

keep conglome_* vivienda_* hogar_* cenl hpan* inghog2d_*
...
reshape long conglome_ vivienda_ hogar_, i(cenl) j(year)

rename *_ *

drop if conglome == ""

tempfile sumpanel_20122016
save `sumpanel_20122016'
...
use `roster2012', clear 

forvalues y = 2013(1)2016 {

	append using `roster`y''
}

merge 1:1 conglome vivienda hogar year using `sumpanel_20122016'
drop _merge 

gen ispanel = inlist(1, hpan1213, hpan1314, hpan1415, hpan1516)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1216.dta", replace

bys cenl: gen numobs = _N
