...
use "panel/2016_2020/sumaria-2016-2020-panelf.dta", clear
...
tempfile sumpanel_20162020
save `sumpanel_20162020'
...
merge 1:1 conglome vivienda hogar year using `sumpanel_20162020'
drop _merge 
...
gen ispanel = inlist(1, hpan1617, hpan1718, hpan1819, hpan1920)
drop if ispanel != 1
drop ispanel 
...
save "enaho_hhrosterlist_1620.dta", replace
