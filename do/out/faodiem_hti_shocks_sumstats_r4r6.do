...
use "faodiem_HTI_mean_incidence_preinc.dta", clear
...
foreach t in any lostjob natdisast accident-illness criminality {
	...
	graph export "faodiem_hti_`t'_preinc.png", replace
	...
	cd "$projdir/out/faodiem"
	graph export "faodiem_hti_`t'_postinc.png", replace
}

foreach t in any lostjob natdisast accident-illness criminality {

	twoway connected inclag_shock_qtly q if shock == "`t'", 	   		   ///
		lcolor(black) mcolor(black) lpattern(solid)    	   			       ///
		ytitle("Quarterly Incidence") 						   			   ///
		legend(off)							       						   ///
		xtitle("pre-shock income level quintile") 			       	       ///
		title("`t'")

	cd "$projdir/out/faodiem"
	graph export "faodiem_hti_`t'_preinc_qtly.png", replace

	twoway connected inc_shock_qtly q if shock == "`t'", 	   	   		   ///
		lcolor(black) mcolor(black) lpattern(solid) 					   ///
		ytitle("Quarterly Incidence") 						   			   ///
		legend(off)							       						   ///
		xtitle("post-shock income level quintile") 			       		   ///
	...
	cd "$projdir/out/faodiem"
	graph export "faodiem_hti_`t'_postinc_qtly.png", replace
}
* -------------------------------------------------------------------